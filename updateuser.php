...
<html>
    ...
    <body class="#212121 grey darken-4">
        ...
        $sql2="UPDATE `usuarios` SET `correo` = '$email', `nombre_usuario` = '$nombre', `apellido_p` = '$apellidop', `apellido_m` = '$apellidom', `password` = '$pass', `admin` = '$admin' WHERE `usuarios`.`id_usuario` = $id;";
